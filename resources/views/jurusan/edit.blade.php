    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="jurusan_id2">
                <div class="form-group">
                    <label for="name" class="control-label">Jurusan</label>
                    <input type="text" class="form-control" id="jurusan-edit2">
                    <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-jurusan-edit2"></div>
                </div>
            </div>
